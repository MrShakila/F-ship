...
- Build number collisions across flavors: scan git tags before bumping so concurrent qa+uat releases from the same base never produce the same `+N` build number

## [0.2.0] - 2026-05-08

### Added

- `fship init` command for quick default config setup
- Enhanced package metadata (classifiers, keywords)
- MIT License file

### Changed

- Simplified config initialization (template-based vs interactive)
